...
Le bot analyse les messages des utilisateurs pour détecter les villes de départ, les villes d'arrivée, et les dates.

Réponses dynamiques :
Si l'utilisateur demande un trajet entre deux villes, le bot filtre les données et répond avec les trajets disponibles.

Gestion des attentes :
Si l'utilisateur ne spécifie pas la ville de départ ou d'arrivée, le bot attend la précision avant de répondre.
capture d'ecran
...
Cas 1 : "Quels trajets existent entre Marseille et Toulouse ?"
"Voici les trajets disponibles de Marseille à Toulouse :
- Train : 3h30 | Prix : 45€
- Bus : 4h00 | Prix : 20€"

Cas 2 : "je veux aller de strasbourg a grenoble"
"Voici les trajets disponibles de Strasbourg à Grenoble :
- Train : 5h15 | Prix : 60€"

### Autre code python :
Création d'un second script Python :
➔ Génération manuelle d'un dictionnaire de questions/réponses
